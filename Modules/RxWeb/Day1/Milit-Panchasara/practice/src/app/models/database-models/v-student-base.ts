...
//#region rollNumber Prop
        @gridColumn({visible: true, columnIndex:1, allowSorting: true, headerKey: 'rollNumber', keyColumn: false})
        rollNumber : number;
//#endregion rollNumber Prop


//#region studentName Prop
        @gridColumn({visible: true, columnIndex:2, allowSorting: true, headerKey: 'studentName', keyColumn: false})
        studentName : string;
...
//#region courseName Prop
        @gridColumn({visible: true, columnIndex:4, allowSorting: true, headerKey: 'courseName', keyColumn: false})
        courseName : string;
