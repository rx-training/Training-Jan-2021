...
function searchByIndexFunc() : string{
...
var searchByID = function () : any{
    return Employee.filter((Employee, index, array) => {
        return Employee.ID == 4;
    });
};
...
function addNewData(newEmp : any) : any{
...
function joinArray(emp : any) : any{
...
var displayList = function (Employee : any) : any{
    for(var x of Employee){
