var employeeData = [["ID", "FirstName", "LastName", "Address", "Salary"],
...
var emp = [[7, "Jimin", "Park", "43, Seoul, South Korea", 14000],
    [8, "Jungkook", "Jeon", "29, Busan, South Korea", 13000]];
console.log("Inserting new employees");
var empRecord = employeeData.concat(emp);
console.log("Employee Record");
for (var i = 1; i < empRecord.length; i++) {
    for (var j = 0; j < 5; j++) {
        if (j == 3) {
            var add = empRecord[i][j].toString();
