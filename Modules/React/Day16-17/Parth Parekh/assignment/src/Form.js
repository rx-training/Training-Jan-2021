...
export default function Form(props) {
    ...
    const handleChange = (event) => {
        ...
        switch (name) {
            case "date":
                let age = calculateAge(new Date(value));
                if (age >= 5 && age <= 20) {
                    errors[name] = "";
                } else {
    ...
    const handleSubmit = (event) => {
        ...
        if (validateForm(errors)) {
            ...
            if (values._id === "_add") {
                ...
                console.log("Id");
                StudentService.updateStudent(studentData, values._id).then(
                    (res) => {
                        console.log("Update");
                        props.history.push("/");
                    }
            ...
            <div className="border m-2 border-primary ">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="m-3 p-3">
                        ...
                        >
                            {values._id === "_add" ? "Submit" : "Edit Data"}
                        </button>
                    </div>
                </form>
            </div>
