...
const App = () => {
  return (
    <section >
      <StudentIdCard Student = {Students[0].Student1}> The Above Student Scored AA grade in exams </StudentIdCard>
      <StudentIdCard Student = {Students[1].Student2}>The Above Student Scored AB grade in exams </StudentIdCard>
      <StudentIdCard Student = {Students[2].Student3}>The Above Student Scored BB grade in exams </StudentIdCard>
    </section>
  );
}
