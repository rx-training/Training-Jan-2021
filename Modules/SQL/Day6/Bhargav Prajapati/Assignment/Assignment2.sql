...
*/
CREATE VIEW CombinaionData6
AS SELECT l.LocationID,l.StreetAddress,l.City,l.StateProvince,c.CountryName FROM Locations l 
...
JOIN Employees e2 ON e1.DepartmentID=e2.ManagerID
...
SELECT CONCAT(FirstName,SPACE(2),LastName)AS'Full Name',HireDate FROM Employees WHERE 
HireDate>(SELECT HireDate FROM Employees WHERE LastName='Jones')
