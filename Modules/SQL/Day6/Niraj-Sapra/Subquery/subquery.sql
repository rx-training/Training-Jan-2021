...
/*Prac 1. Write a query to find the names (first_name, last_name) and salaries of the employees who have higher salary 
than the employee whose last_name='Bull'.  */

SELECT e.FirstName,e.LastName,e.Salary FROM Employees e WHERE Salary > (SELECT emp.Salary FROM Employees emp WHERE emp.LastName = 'Bull');

/*Prac 2. Find the names (first_name, last_name) of all employees who works in the IT department.  */

SELECT e.firstName,e.lastName,e.JobId FROM Employees e WHERE e.DepartmentID = (SELECT d.DepartmentID FROM Departments d WHERE d.DepartmentName = 'IT'); 

/*Prac 3. Find the names (first_name, last_name) of the employees who have a manager who works for a department
...
/*Prac 8. Find the names (first_name, last_name), salary of the employees who earn more than Mr. Bell.  */

SELECT FirstName,LastName,Salary From  Employees WHERE Salary > (SELECT  Salary FROM Employees WHERE LastName='Bell');

/*Prac 9. Find the names (first_name, last_name), salary of the employees who earn the same salary as the minimum salary for all departments.  */

SELECT FirstName,LastName,Salary,DepartmentID From  Employees WHERE Salary = (SELECT MIN(Salary) FROM Employees);


/*Prac 10. Find the names (first_name, last_name), salary of the employees whose salary greater than average salary of all department.  */

SELECT FirstName,LastName,Salary From  Employees WHERE Salary > (SELECT AVG(Salary) FROM Employees);


/*Prac 11. Write a query to find the names (first_name, last_name) and salary of the employees who earn a salary that is higher than the salary of all the Shipping Clerk (JOB_ID = 'SH_CLERK'). Sort the results on salary from the lowest to highest.  */

SELECT FirstName,LastName,Salary
FROM Employees WHERE Salary > ALL 
(SELECT Salary FROM Employees WHERE JobId = 'SH_CLERK') ORDER BY Salary;
/*Prac 12. Write a query to find the names (first_name, last_name) of the employees who are not supervisors.  */
SELECT e.FirstName,e.LastName
FROM Employees e WHERE NOT EXISTS(SELECT * FROM Employees emp WHERE emp.ManagerID = e.EmployeeID);


/*Prac 13. Write a query to display the employee ID, first name, last names, and department names of all employees.  */
...
/*Prac 16. Write a query to find the 5th maximum salary in the employees table.  */
...
/*Prac 17. Write a query to find the 4th minimum salary in the employees table.  */
...
/*Prac 18. Write a query to select last 10 records from a table.  */


SELECT TOP 10 * FROM Employees ORDER BY
EmployeeID DESC;

/*Prac 19. Write a query to list department number, name for all the departments in which there
