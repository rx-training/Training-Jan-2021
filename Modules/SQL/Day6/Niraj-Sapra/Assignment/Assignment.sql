...
/*Assignment 1:-Select employee details from employee table if data exists in incentive table ?*/

SELECT * From Employees e  where exists(select EMPLOYEE_REF_ID from INCENTIVES i Where e.EmployeeID = i.EMPLOYEE_REF_ID );


/*Assignment 2:-Find Salary of the employee whose salary is more than Roy Salary*/
UPDATE Employees SET FirstName='Roy' WHERE EmployeeID=126;

SELECT FirstName,LastName,Salary From Employees   where Salary > (select Salary FROM Employees e  WHERE e.FirstName = 'Roy' );

/*Assignment 3:-Create a view to select FirstName,LastName,Salary,JoiningDate,IncentiveDate and IncentiveAmount */

CREATE VIEW NEWViews As SELECT e.FirstName,e.LastName,e.Salary,e.HireDate,i.INCENTIVE_AMOUNT 
