...
-- Salary between 23000 and 40000 — 5000 hike
-- Salary between 40000 and 55000 — 7000 hike
-- Salary between 55000 and 65000 — 9000 hike
SELECT * FROM Employees
-- to reset salary 24000 after running query of cursor
UPDATE Employees SET Salary = 24000 WHERE EmployeeID = 100

SET NOCOUNT ON
DECLARE @id INT, @salary MONEY, @tmpsalary MONEY
...
OPEN hike_salary
	...
	BEGIN
		SET @salary = CASE 
			WHEN @salary BETWEEN 23000 and 40000
				THEN @salary + 5000
