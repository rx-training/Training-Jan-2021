...
-->1
SELECT FirstName AS 'Name',LEN(FirstName) AS 'Lenght' FROM Employees WHERE FirstName LIKE 'A%' OR FirstName LIKE 'J%' OR FirstName LIKE 'M%' ORDER BY FirstName ;
-->2
SELECT FirstName , ('$'+STR(Salary*'10000'))FROM Employees
-->3
SELECT FirstName ,LastName  FROM Employees WHERE MONTH(HireDate)=07 OR YEAR(HireDate)=07;
-->4
SELECT LEN(FirstName) FROM Employees WHERE LastName like'%c' AND CHARINDEX('c', LastName)>2;
-->5
SELECT RIGHT(PhoneNumber,4)FROM Employees;
-->6 
SELECT REPLACE(PhoneNumber,124,999)FROM  Employees;
-->7
SELECT DATEDIFF(YEAR,('1999-12-10'),(GETDATE()));
-->8
SELECT DISTINCT HireDate FROM Employees WHERE DATEPART(WEEKDAY,HireDate)=2;
...
-->12
SELECT FirstName ,LastName  FROM Employees WHERE MONTH(HireDate)=06;
-->13
