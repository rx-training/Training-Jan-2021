...
--Practice 2
WITH tbl (SalesPersonID, NumberOfOrders) AS  
(  
...
SELECT AVG(NumberOfOrders) AS "Average Sales Per Person" FROM tbl; 
...
SELECT SalesPersonID  
  ...
  , FORMAT (TotalSales -SalesQuota, 'C','en-us') AS 'Amount Above or Below Quota'
FROM Sales_CTE  
