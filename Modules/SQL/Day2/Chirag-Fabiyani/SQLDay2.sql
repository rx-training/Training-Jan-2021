...
ALTER TABLE Employees DROP ukEmail;
...
UPDATE Employees SET Email='Not Available' WHERE JobId = 'FI_ACCOUNT' OR JobId = 'AC_ACCOUNT';
...
---- Write a SQL statement to increase the minimum and maximum salary of PU_CLERK by 2000 as well as the----
