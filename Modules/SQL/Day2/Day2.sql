...
ALTER TABLE Employees ADD Min_Salary decimal(8,2) DEFAULT NULL;
ALTER TABLE Employees ADD Max_Salary decimal(8,2) DEFAULT NULL;
UPDATE Employees SET Min_Salary = '2000.00' , Max_Salary = '2000.00' , Salary = Salary+Salary*20/100 , CommissionPct = CommissionPct+0.10 WHERE JobId='PU_CLERK';
...
ALTER TABLE Employees ADD PF decimal(8,2) DEFAULT NULL;
UPDATE Employees SET PF = Salary+Salary*12/100;
SELECT * FROM Employees;