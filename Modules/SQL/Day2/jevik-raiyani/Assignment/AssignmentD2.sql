...
UPDATE Employees
SET Email = 'no avaliable'

2
UPDATE Employees
SET Email = 'no avaliable'	,CommissionPct = 0.10

3
UPDATE Employees
SET Email = 'no avaliable'	,CommissionPct = 0.10 WHERE DepartmentID = 110

=>
UPDATE Employees
SET Email = 'no avaliable' WHERE DepartmentID = 80 AND CommissionPct < 0.2

=>
UPDATE Employees
SET Email = 'no avaliable' WHERE JobId LIKE '%ACCOUNT'

=>
UPDATE Employees
SET Salary = 8000 WHERE EmployeeID = 105 OR Salary <5000

=>
UPDATE Employees
SET JobId ='SH_CLERK' WHERE EmployeeID =118 OR (DepartmentID =30 AND JobId NOT LIKE 'SH%')
...
=>
UPDATE Employees
SET Salary+= 2000, CommissionPct=CommissionPct*.1 WHERE JobId ='PU_CLERK'
...
=>
SELECT FirstName+LastName ' FULLNAME' , Salary, Salary*.12 'PF' FROM Employees
...
=>
SELECT EmployeeID, FirstName+LastName ' FULLNAME' , Salary FROM Employees ORDER BY Salary

=>
SELECT TOP 2 Salary FROM Employees
SELECT TOP 20 PERCENT  Salary FROM Employees
