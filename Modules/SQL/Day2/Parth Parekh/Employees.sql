...
/*** 3.  Write a SQL statement to change the Email and CommissionPct column of employees table with ‘not available’ and 0.10 for those employees
...
/*** 6. Write a SQL statement to change job ID of employee which ID is 118, to SH_CLERK if the employee 
