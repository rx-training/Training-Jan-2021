...
UPDATE Employees SET Salary = Salary+ (Salary * 0.2), CommissionPct = CommissionPct + (CommissionPct * 0.1)
...
SELECT FirstName+' '+LastName AS 'Names', Salary, PF = 0.12 * Salary  FROM Employees
