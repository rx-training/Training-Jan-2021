...
SELECT Email, CommissionPct FROM Employees
...
SELECT Email, CommissionPct, DepartmentID FROM Employees WHERE DepartmentID = '110'
...
SELECT Email, CommissionPct, DepartmentID  FROM Employees WHERE DepartmentID = '80' AND CommissionPct < 0.20;
...
SELECT Salary, DepartmentID FROM Employees WHERE EmployeeID = '105'
...
SELECT JobID, DepartmentID FROM Employees WHERE EmployeeID = '118'
...
SELECT Salary, DepartmentID FROM Employees
...
SELECT Salary, CommissionPct, JobID FROM Employees WHERE JobID = 'PU_CLERK'
