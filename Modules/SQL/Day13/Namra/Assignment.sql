...
Rs 12000 and above	Rs. 200/month*/
	...
	SELECT dbo.Function2(10000);

--Create a table valued function which will accept incentive percentage and calculate salary with incentive. incentive dependent on amount of sale, if sales is more than 10
	...
	--Function
	CREATE FUNCTION dbo.Function3(@IncentivePercentage INT)
	RETURNS TABLE 
	AS
