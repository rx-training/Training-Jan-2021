        ...
        if (!assignmentData) {
            ...
            for(let i = 0 ; i < empData.length ; i++)
            {
                for( let j = 0 ; j < empData[i].Assignments.length ; j++)
                {
                    ...
                    empData[i].Assignments[j].AssignmentId = data.AssignmentId;
                    empData[i].Assignments[j].AssignmentName = data.AssignmentName;
                    empData[i].Assignments[j].AssignmentCategory = data.AssignmentCategory;
                    empData[i].Assignments[j].AssignmentStatus = data.AssignmentStatus;
                }
            }
