...
namespace Assignment
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<HOSPITAL11Context>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnStr")));
            ...
            //services.AddTransient<IMedicineAssigned, MedicineAssignedRepository>();
