...
namespace Assignment.Controllers
{
    ...
    public class AssignmentsController : ControllerBase
    {
        ...
        [HttpGet ]
        public async Task<ActionResult<IEnumerable<Assignment_webapi.Model.Assignment>>> GetAssignments()
        {
            return await _context.Assignments.ToListAsync();
        }
        [HttpGet ("{empID}/child/assignments")]
        public async Task<ActionResult<IEnumerable<Assignment_webapi.Model.Assignment>>> GetAssignments(int empID)
        {
        ...
        public async Task<ActionResult<IEnumerable<Assignment_webapi.Model.Assignment>>> GetAssignmentsWithEmp(int Assignmentid, int empid)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Assignment_webapi.Model.Assignment>> GetAssignment(int id)
        {
        ...
        public async Task<IActionResult> PutAssignment(int empID, int AssignmentID, Assignment_webapi.Model.Assignment assignment)
        {
