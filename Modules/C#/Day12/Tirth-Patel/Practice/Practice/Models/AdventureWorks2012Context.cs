...
namespace Practice.Models
{
    public partial class AdventureWorks2012Context : DbContext
    {
        ...
        public virtual DbSet<DelSave> DelSaves { get; set; }
        public virtual DbSet<Department> Departments { get; set; }
        public virtual DbSet<EmailAddress> EmailAddresses { get; set; }
        public virtual DbSet<EmpMgr> EmpMgrs { get; set; }
        public virtual DbSet<Employee> Employees { get; set; }
        public virtual DbSet<EmployeeDepartmentHistory> EmployeeDepartmentHistories { get; set; }
        public virtual DbSet<EmployeePayHistory> EmployeePayHistories { get; set; }
        public virtual DbSet<ErrorLog> ErrorLogs { get; set; }
        public virtual DbSet<Glofe> Gloves { get; set; }
        public virtual DbSet<Illustration> Illustrations { get; set; }
        public virtual DbSet<Indian> Indians { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=AdventureWorks2012;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DelSave>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Del_save");
            ...
            modelBuilder.Entity<Department>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Name, e.ModifiedDate }, "NonClusteredIndex-20210312-141316");
            ...
            modelBuilder.Entity<EmpMgr>(entity =>
            {
                entity.HasKey(e => e.Emp)
                    .HasName("PK__emp_mgr__D950BEFC79DFE44A");

                entity.ToTable("emp_mgr");
                ...
                entity.Property(e => e.NooFreports)
                    .HasColumnName("NOoFReports")
                    .HasDefaultValueSql("((0))");

                entity.HasOne(d => d.MgrNavigation)
                    .WithMany(p => p.InverseMgrNavigation)
                    .HasForeignKey(d => d.Mgr)
                    .HasConstraintName("FK__emp_mgr__mgr__4D7F7902");
            });
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.BusinessEntityId, e.JobTitle, e.Gender }, "IX_ID_Title");
            ...
            modelBuilder.Entity<Glofe>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("gloves");
            ...
            modelBuilder.Entity<Indian>(entity =>
            {
                entity.HasNoKey();

                entity.HasIndex(e => e.AdhaarId, "ClusteredIndex-20210312-192435")
                    .IsClustered();

                entity.HasIndex(e => new { e.Name, e.Email }, "NonClusteredIndex-20210312-192452");

                entity.Property(e => e.AdhaarId)
                    .HasMaxLength(10)
                    .HasColumnName("ADhaar_ID")
                    .IsFixedLength(true);
            ...
            modelBuilder.Entity<NewProduct>(entity =>
            {
                ...
                entity.Property(e => e.CsPname).HasColumnName("cs_Pname");
            ...
            modelBuilder.Entity<Person>(entity =>
            {
                ...
                entity.HasIndex(e => e.FirstName, "<Name of Missing Index, sysname,>");
            ...
            modelBuilder.Entity<PlanetsId>(entity =>
            {
                ...
                entity.HasIndex(e => e.Id, "IX_PlanetsID_ID")
                    .IsClustered();
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => e.CsPname, "Pname_index");
                ...
                entity.Property(e => e.CsPname)
                    .HasColumnName("cs_Pname")
                    .HasComputedColumnSql("(checksum([Name]))", false);
            ...
            modelBuilder.Entity<ProductResult>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<SalesOrderDetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductId, "IX_SalesOrderDetails_ID");
            ...
            modelBuilder.Entity<SalesPerson>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.SalesQuota, e.SalesYtd }, "IX_SalesPerson_SalesQuota_SalesYTD");
            ...
            modelBuilder.Entity<Store1>(entity =>
            {
                ...
                entity.HasOne(d => d.BusinessEntity)
                    .WithOne(p => p.Store1)
                    .HasForeignKey<Store1>(d => d.BusinessEntityId)
                    .OnDelete(DeleteBehavior.ClientSetNull);
            ...
            modelBuilder.Entity<TestTable>(entity =>
            {
                ...
                entity.HasIndex(e => e.Testcol1, "IX_TestTable_Testcol1")
                    .IsClustered();
            ...
            modelBuilder.Entity<VOrder>(entity =>
            {
                ...
                entity.Property(e => e.Revenue).HasColumnType("numeric(38, 6)");
            });
