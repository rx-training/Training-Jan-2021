...
namespace Day3Practice
{
    class Day3Bank
    {
        ...
        {
            var giftCard = new Bank3.GiftCardAmount("gift card", 100, 50);
            ...
            //var lineOfCredit = new LineOfCreditAccount("line of credit", 0);//fails because account takes value greater than 0 
