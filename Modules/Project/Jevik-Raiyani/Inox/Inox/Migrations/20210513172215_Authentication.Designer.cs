...
namespace Inox.Migrations
{
    ...
    [Migration("20210513172215_Authentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inox.Models.Ticket", b =>
                {
                    ...
                    b.HasIndex(new[] { "ShowTimeId", "SeatId" }, "UkshowTimeSeatID")
                        .IsUnique();
            ...
            modelBuilder.Entity("Inox.Models.VTransactionHistory", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Inox.Models.Row", b =>
                {
                    b.HasOne("Inox.Models.Screen", "RowNavigation")
                        .WithOne("Row")
                        .HasForeignKey("Inox.Models.Row", "RowId")
                        .HasConstraintName("FK_Rows_Screens")
                        .IsRequired();

                    b.Navigation("RowNavigation");
                });
