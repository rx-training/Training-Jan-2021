...
export class Tiket extends Component {
    ...
    render() {
        const {selectedFlight , returnSelectedFlight , passengerDetails , name , guests , flight , returnFlight , totalTicket , totalFare , totalCharge , totalExtras ,grandTotal  } = this.props.data
        return (
            <>
