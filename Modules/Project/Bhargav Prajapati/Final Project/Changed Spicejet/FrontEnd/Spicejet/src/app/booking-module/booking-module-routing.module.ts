...
import { AuthGuardGuard } from '../Authentication/Auth/auth-guard.guard';
...
const routes: Routes = [
  ...
  [
    ...
    {path:"Statusofflight",component:StatusOfFlightComponent,canActivate:[AuthGuardGuard]},
    {path:"check-in",component:CheckInComponent},
    {path:"check-in-Details",component:CheckInDetailsComponent,canActivate:[AuthGuardGuard]},
    {path:"MenageBooking",component:MenageBookingComponent},
    {path:"MenageBookingDetails",component:MenageBookingDetailsComponent,canActivate:[AuthGuardGuard]},
    {path:"Flight",component:FlightComponent},
    {path:"BookingFlight/:id",component:BookingofFlightComponent,canActivate:[AuthGuardGuard]},
    ...
    {path:"HotelBooking",component:BookingHotelComponent,canActivate:[AuthGuardGuard]},
    {path:"SearchBooking",component:SearchHotelBookingComponent,canActivate:[AuthGuardGuard]},
    {path:"UserBookingHotel",component:HotelBookinDetailsComponent,canActivate:[AuthGuardGuard]}
