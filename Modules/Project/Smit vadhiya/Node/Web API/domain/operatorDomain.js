...
class Operatores{
    ...
    static async postNewOperator(req,res){
        ...
        if(operatorData.error){
            ...
            var id = await logicalFunctions.incId('Operatores')
            try {
                const newOperator = new Collections.Operatores({
                    _id : id,
                    firstName: operatorData.value.firstName,
                    lastName: operatorData.value.lastName,
                    email: operatorData.value.email,
                    gender: operatorData.value.gender,
                    DOB: operatorData.value.DOB,
                    companyName: operatorData.value.companyName,
                    address: operatorData.value.address,
                    password: operatorData.value.password,
                    collaborationDate : operatorData.value.collaborationDate,
                    phoneNumber: operatorData.value.phoneNumber,
                    city: operatorData.value.city
                })
