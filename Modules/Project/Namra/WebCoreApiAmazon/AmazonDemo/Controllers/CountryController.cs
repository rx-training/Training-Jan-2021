...
namespace AmazonDemo.Controllers
{
    ...
    public class CountryController : ControllerBase
    {
        ...
        {
            if(ctr.CountryId == null || ctr.CountryId == 0 || country.Any(s=> s.CountryId == ctr.CountryId))
            {
                return $"Please enter a country id, if so then change it...";
            }
        ...
        {
            if (country.Any(s => s.CountryId == CountryId))
            {
