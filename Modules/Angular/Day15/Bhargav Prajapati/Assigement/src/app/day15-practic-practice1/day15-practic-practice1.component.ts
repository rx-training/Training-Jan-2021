...
@Component({
  selector: 'app-day15-practic-practice1',
  templateUrl: './day15-practic-practice1.component.html',
  styleUrls: ['./day15-practic-practice1.component.css']
})
export class Day15PracticPractice1Component implements OnInit {
