...
export class StudentComponent implements OnInit, OnChanges {
  ...
  @Input() editValue: IStudent =  {id: 0, address: "", dob: new Date(), emergencyContact: [], fatherDesignation: "", fatherEmail: "", fatherName: "", fatherPhone: "", fatherProfession: "", fatherQualification: "", language: "", motherDesignation: "", motherEmail: "", motherName: "", motherPhone: "", motherProfession: "", motherQualification: "", name: "", placeOfBirth: "", referenceDetails: []}; ​​
  ...
  profileSubmit(){
    ...
    var newStudent: IStudent = {
      id: this.id != null ? this.id : this.studentService.getList().length + 1,
    ...
    if(this.index != newStudent.id){ 
      this.studentService.addData(newStudent);
      console.log("data added successfully!");
    }

    else{
      this.studentService.updateData(newStudent);
    ...
    this.userData.emit({service: this.studentService, IsSubmitted: this.submitted});
  ...
  ngOnChanges(changes: SimpleChanges){
      ...
      this.studentForm.setControl('emergencyContacts', this.setExistingEergencyContacts(this.editValue.emergencyContact));
