...
export class FormValidationComponent implements OnInit {
  ...
  constructor(private formbuilder:FormBuilder){  this.Studentform = this.formbuilder.group(
    {
      ...
      fathername: this.formbuilder.group({
        ...
        Femil:['',Validators.email,Validators.required],
      ...
      mothername: this.formbuilder.group({
        ...
        memail:['',Validators.email,Validators.required],
  ...
  get fname(){
    return this.Studentform.controls.name.get('name.fname');    
  }
  get mname(){
...
// function agevalidation(contorl:FormControl):{[s:number]:boolean}
// {
//   if(!contorl.value.match(/^98/)){
//     return true;
//   }
// }
