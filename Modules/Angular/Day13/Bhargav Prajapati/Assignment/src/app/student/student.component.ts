...
//   ngOnInit(): void {
//     this.StudentAdmission=this.fb.group({
//       StudentName:[''],
//       DateofBirth:[''],
//       PlaceofBirth:[''],
...
// SubmitData():void
// {
//   this.StoreData=this.StudentAdmission.value;
//   this.Childtoparent.emit(this.StoreData);
...
// }
  ...
  @Output() SendData =new EventEmitter()
    SubmitData()
    {
      ...
      this.SendData.emit(this.StudentAddmissionDetails.value)
