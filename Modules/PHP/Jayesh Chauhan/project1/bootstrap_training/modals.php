                    ...
                    <div id="content">
                        <div class="container text-dark">
                            <header class="display-1">
                                <p class="text-dark text-center">Modals</p>
                            </header>
                            <hr>
                            <ul class="nav nav-justified sticky-top">
                                ...
                                <li class="nav-item bg-danger rounded">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="modals.php" class="dropdown-item active">modals</a>
                                    </div>
                                </li>
                            </ul>
                            <hr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde dicta inventore excepturi odit, voluptate est assumenda cum quasi delectus veniam nobis, iure illo esse placeat amet cupiditate quidem Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                    Repudiandae quae accusamus deleniti quidem explicabo exercitationem, voluptatem eum vitae optio laudantium ea possimus itaque nostrum ipsum totam minus! Officia, cum obcaecati?
                                                </div>
