                    ...
                    <div id="content">
                        <div class="container">
                            <header class="display-1">
                                <p class="text-dark text-center">Alerts & Progress Bars</p>
                            </header>
                            <hr>
                            <ul class="nav nav-justified sticky-top">
                                ...
                                <li class="nav-item bg-success mr-1 rounded">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="alerts_&_progress.php" class="dropdown-item active">alerts_&_progress</a>
                            ...
                            <section class="mt-3">
                                <div class="container">
                                    ...
                                    <div class="alert alert-success alert-dismissible">
                                        ...
                                        <strong>Dismissible</strong> Blog post added
                                    </div>
                                    <div class="progress">
                                    ...
                                    <br>
                                    <div class="progress">
                                        <div class="progress-bar bg-danger progress-bar-striped" style="width:65%;"></div>
                                    </div>
                                    <br>
                                    <div class="progress">
