                    ...
                    <div id="content">
                        <div class="container">
                            <header class="display-1">
                                <p class="text-dark text-center">Carousel</p>
                            </header>
                            <hr>
                            <ul class="nav nav-justified sticky-top">
                                ...
                                <li class="nav-item bg-danger rounded">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="carousel.php" class="dropdown-item active">carousel</a>
                                            ...
                                            <div id="slider1" class="carousel slide mb-5" data-ride="carousel">
                                                <div class="carousel-inner" role="listbox">
                                                    <div class="carousel-item active">
                                                        <img src="https://picsum.photos/600/300/" style="width: 800px;height:300px;" alt="image1" class="d-block img-fluid">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="https://picsum.photos/600/400/" style="width: 800px;height:300px;" alt="image2" class="d-block img-fluid">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="https://picsum.photos/600/200/" style="width: 800px;height:300px;" alt="image3" class="d-block img-fluid">
                                                    </div>
                                                </div>
                                            </div>
