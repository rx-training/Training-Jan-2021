                    ...
                    <div id="content">
                        <div class="container">
                            <header class="display-1">
                                <p class="text-dark text-center">Flexbox</p>
                            </header>
                            <hr>
                            <ul class="nav nav-justified sticky-top">
                                ...
                                <li class="nav-item bg-warning mr-1 rounded">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="flexbox.php" class="dropdown-item active">flexbox</a>
                            ...
                            <section class="mt-3">
                                <div class="container text-dark">
                                    <div class="d-flex flex-row raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row-reverse raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row justify-content-start raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row justify-content-center raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row justify-content-end raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row justify-content-around raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row justify-content-between raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-column raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-column-reverse raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row align-items-start raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row align-items-center raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row align-items-end raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row align-items-baseline raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row align-items-streched raw-hl">
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row raw-hl">
                                        <div class="p-4 align-self-start" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-center" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-end" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-baseline" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-between" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                    <br><br>
                                    <div class="d-flex flex-row raw-hl">
                                        <div class="p-4 align-self-md-start" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-md-center" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-md-end" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-md-baseline" style="border:1px solid #333;">Flex item</div>
                                        <div class="p-4 align-self-md-between" style="border:1px solid #333;">Flex item</div>
                                    </div>
                                </div>
                            </section>
