                    ...
                    <div id="content">
                        <div class="container text-dark">
                            <header class="display-1">
                                <p class="text-dark text-center">Popovers</p>
                            </header>
                            <hr>
                            <ul class="nav nav-justified sticky-top">
                                ...
                                <li class="nav-item bg-danger rounded">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="popovers.php" class="dropdown-item active">popovers</a>
                            ...
                            <section class="mt-3">
                                <div class="container">
                                    <button class="btn btn-primary" data-toggle="popover" data-placement="top" title="Popover title" data-content="Lorem ipsum dolor sit amet.">Toggle popover on top</button>
                                    <button class="btn btn-secondary" data-toggle="popover" data-placement="right" title="Popover title" data-content="Lorem ipsum dolor sit amet.">Toggle popover on right</button>
                                    <button class="btn btn-warning" data-toggle="popover" data-placement="bottom" title="Popover title" data-content="Lorem ipsum dolor sit amet.">Toggle popover on bottom</button>
                                    <button class="btn btn-danger" data-toggle="popover" data-placement="left" title="Popover title" data-content="Lorem ipsum dolor sit amet.">Toggle popover on left</button>
                                    <br><br>
                                    <button id="myPopover" class="btn btn-primary" id="hello" data-toggle="popover" data-placement="right" title="Popover title" data-content="Lorem ipsum dolor sit amet." data-trigger="focus">Toggle popover</button>
                                    <br><br>
                                    <button class="btn btn-secondary" onclick="showpopover()">Show popover</button>
                                    <button class="btn btn-secondary" onclick="hidepopover()">Hide popover</button>
                                    <button class="btn btn-secondary" onclick="togglepopover()">Toogle popover</button>
                                </div>
                            </section>
